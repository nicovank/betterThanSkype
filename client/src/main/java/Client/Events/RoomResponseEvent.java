...
public class RoomResponseEvent extends Event {
    public static final EventType<RoomResponseEvent> JOIN_ROOM = new EventType<>("JOIN_ROOM");
    public static final EventType<RoomResponseEvent> CREATE_ROOM = new EventType<>("LEAVE_ROOM");
